...
@TeleOp(name = "Test: Rev ColorSensor V3", group = "Tests")
public class RevColorSensorV3Test extends OpMode {
	RevColorSensorV3 colorSensorV3;
	ColorSensor wrapper;
	
	@Override
	public void init() {
		colorSensorV3 = hardwareMap.get(RevColorSensorV3.class, Settings.Hardware.TRANSFER_COLOR_SENSOR.getName());
